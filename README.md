# EEPRS
EEPRS (Electronic Health Record Embedding integrated Polygenic Risk Score) is a phenotype embedding-based PRS interpretation and integration framework designed to effectively combine high-dimensional EHR data with traditional PRS.
